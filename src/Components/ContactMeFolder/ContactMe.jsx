...
const ContactMe = () => {
  return (
    <div className="ContactButtonHide z-50 m-auto -mb-5 hidden h-full w-full items-center justify-center xs:flex">
      <div
        id="contact"
        className="buttonsAllWrapper m-auto w-fit cursor-pointer px-1 pb-2 duration-500 ease-in-out hover:scale-[100.8%]"
      >
        <a
