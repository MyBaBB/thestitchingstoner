...
const AnimatedDetails = () => {
  ...
  return (
    <div className="trippy-stage">
      <div className="trippy-card flex flex-col items-center text-center font-Itim-Regular leading-relaxed  after: ">
       ...
       <a href="https://thestitchingstoner.square.site/product/crochet-101-the-basics/FR5XDEGDJ3HEPOUPPTVS2BNP" className="hover:opacity-90 hover:scale-105 ">
          <div className="vanSlideInInstaller0  ">< VanSlideIn2 /></div>
       </a>

     < div className="stonerText  border-4 border-blue-500 ">
            <p className="stonerLine   line11 " data-text="High‑vibe Stitching for Classes">
